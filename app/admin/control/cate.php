...
class cate_c extends Control
{
	...
	function set_f()
	{
		...
		//取得模块中的扩展字段
		$keylist = $this->module_m->fields_index($mid);
		$this->tpl->assign("keylist",$keylist);
	...
	function setok_f()
	{
		...
		$array["description"] = $this->trans_lib->safe("description");
			$array["jsjj"] = $this->trans_lib->html("jsjj");
		$array["jslx"] = $this->trans_lib->html("jslx");
		$array["jsys"] = $this->trans_lib->html("jsys");
		$array["dna"] = $this->trans_lib->html("dna");
		$array["aljx"] = $this->trans_lib->html("aljx");
