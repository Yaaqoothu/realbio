var BDBridge = window.BDBridge || (function(){
    ...
    if ((CONFIG.BD_BRIDGE_OPEN == 1) && (typeof window["BD_BRIDGE_LOADED"] == "undefined")) {
        ...
        script.src = CONFIG.BD_BRIDGE_ROOT + "asset/js/bw.js?v=20140515";
    ...
    return self = {
        ...
        BD_BRIDGE_DATA : {mainid : "120470114", SITE_ID : "b7846b76509870fb281764766a413e46", siteid : "4689508", userName: 'bj-诺禾致源'},
        OPEN_MODULAR : 11111,
                BD_BRIDGE_SPECIAL :  [] ,
