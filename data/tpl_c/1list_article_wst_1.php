...
<div class="main">
 ...
 <style>
  ...
  <div class="sh">
	...
	<ul id="suckertree1">
	<li class="lia" >
    <a style="background:url(tpl/www/images/y-aaa.jpg) no-repeat top;" href="index.php?c=list&cs=wstphyjk" >
    <p>人体微生态平衡与健康</p></a>
	</li>
    <li class="lib">
    <a  href="index.php?c=list&cs=azzdyyy" >
    <p>癌症诊断与用药</p></a>
	</li>
    <li  class="lic">
  ...
  <div class="clear"></div>
	<div class="left"> 
            <!--<pre><?php echo print_r($rs,true);?></pre>--> 
     <?php $catelist = phpok_s_catelist(181);?>
<div class="border-lr">
<ul id="suckertree1">
