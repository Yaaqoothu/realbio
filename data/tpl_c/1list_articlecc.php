...
<div class="main">
  ...
  <div class="sh">
    ...
    <li  class="lic">
    <a style="background:url(tpl/www/images/aac.jpg) no-repeat top;" href="index.php?c=list&cs=dongzhiwuzuzhongcexu" >
    <p>重测序</p></a>
	</li>
    <li  class="lif">
  ...
  <div class="clear"></div>
	<div class="left">     <!--<pre><?php echo print_r($rs,true);?></pre>--> 
     <?php $catelist = phpok_s_catelist(139);?>
<div class="border-lr">
<ul id="suckertree1">
...
<?php unset($catelist);?>
	...
	<div class="right">
	<div class="vmenu"><h3 style="width:100px;"><?php echo $rs[cate_name];?></h3></div>
