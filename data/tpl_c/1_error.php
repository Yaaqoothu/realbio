...
<title>泰纳网络科技提示 -- <?php echo $_sys[sitename];?><?php if($_sys[seotitle]){?> -- <?php echo $_sys[seotitle];?><?php } ?></title>
...
<div class="error">
	...
	<div class="foot"><?php echo sys_debug();?><br />Powered by 泰纳网络科技网站建设专家, CopyRight &copy; 2007-2013 All rights reserved.</div>
</div>
<?php if($error_url){?>
<script type="text/javascript">
