...
<div class="main">
  ...
  <div class="sh">
	...
	<ul id="suckertree1">
	<li class="lia" >
    <a  styl href="index.php?c=list&cs=danjundongzhiwudenovocexu" >
    <p>微生物基因组测序</p></a>
	</li>
    <li class="lib">
    ...
    <li  class="lie">
    <a style="background:url(tpl/www/images/aae.jpg) no-repeat top;" href="index.php?c=list&cs=fuwuqijiqundajian" >
    <p>集群搭建</p></a>
	</li>
	</ul>
	</div>
  ...
  <div class="clear"></div>
	<div class="left">     <!--<pre><?php echo print_r($rs,true);?></pre>--> 
     <?php $catelist = phpok_s_catelist(116);?>
<div class="border-lr">
<ul id="suckertree1">
...
<li><a href="<?php echo list_url($value);?>"><?php echo $value[cate_name];?></a>
  ...
  <ul>
    ...
    <li class="dd"><a href="<?php echo list_url($v);?>" ><?php echo $v[cate_name];?></a></li>
   <?php } ?>
  </ul>
  <?php unset($sonlist);?>
</li>
